...
@testset "Function: get_outlier_duplicate_columns" begin
    ...
    components_indexes1 = StateSpaceLearning.get_components_indexes_unobserved_components(10, 3, Exogenous_X1, true, "Basic Structural", 0)
    components_indexes2 = StateSpaceLearning.get_components_indexes_unobserved_components(10, 3, Exogenous_X2, true, "Basic Structural", 0)

    Estimation_X1 = StateSpaceLearning.create_X_unobserved_components("Basic Structural", 10, 3, Exogenous_X1, true, 0)
    ...
    Estimation_X2 = StateSpaceLearning.create_X_unobserved_components("Basic Structural", 10, 3, Exogenous_X2, true, 0)
