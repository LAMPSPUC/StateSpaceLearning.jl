...
@testset "Function: get_path_information_criteria" begin
    ...
    model1 = glmnet(
        ...
        dfmax=size(Estimation_X, 2),
        lambda_min_ratio=0.001,
    )
    coefs1, ε1 = StateSpaceLearning.get_path_information_criteria(
        model1, Estimation_X, estimation_y, "aic"; intercept=intercept1
    )
    ...
    coefs2, ε2 = StateSpaceLearning.get_path_information_criteria(
        model2, Estimation_X, estimation_y, "aic"; intercept=intercept2
    )
...
@testset "Function: fit_glmnet" begin
    coefs, ε = StateSpaceLearning.fit_glmnet(
        Estimation_X,
        estimation_y,
        α;
...
@testset "Function: fit_lasso" begin
    ...
    components_indexes2 = StateSpaceLearning.get_components_indexes(
        Basic_Structural_w_level
    )
...
@testset "Function: get_outlier_duplicate_columns" begin
    ...
    outlier_duplicate_columns1 = StateSpaceLearning.get_outlier_duplicate_columns(
        X, components_indexes
    )
    @test outlier_duplicate_columns1 == [32]

    outlier_duplicate_columns2 = StateSpaceLearning.get_outlier_duplicate_columns(
        X2, components_indexes2
    )
